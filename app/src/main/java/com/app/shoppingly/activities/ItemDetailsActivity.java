...
public class ItemDetailsActivity extends BaseActivity {
    ...
    ImageView imgPlant;
    TextView tvPlantName, tvPrice, tvDescription;
    Button btnAddToCart;
    String userId="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        model = AllProductsFragment.model;
        ...
        //Set all the data in views..
        Picasso.with(this).load(model.getPicUrl()).placeholder(R.drawable.holder).into(imgPlant);
        tvPlantName.setText(model.getTitle());
        ...
        btnAddToCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder dailogBuilder = new AlertDialog.Builder(ItemDetailsActivity.this);
